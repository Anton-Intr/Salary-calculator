...
class Params:
    def __init__(
        self,
        account_key: str = Query(None, description='Jira key, you can get it by visiting your Jira profile and copy-pasting key from URL, like 5a4ce9e3ebeb8229f4b2d45a'),
        tempo_token:str = Query(None, description='API token for Tempo integration. See docs for getting it: https://apidocs.tempo.io/#section/Authentication#using-the-rest-api-as-an-individual-user'),
